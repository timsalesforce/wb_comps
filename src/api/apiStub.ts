    ...
    return {
        ...
        "fields": [
          ...
          },
          {
            ...
            "byteLength": 3900,
            "calculated": true,
            "calculatedFormula": "TEXT(HOUR(TIMEVALUE(WithSeconds__c))) + ':'  + TEXT(MINUTE(TIMEVALUE(WithSeconds__c))) + ':' + TEXT(SECOND(TIMEVALUE(WithSeconds__c)))",
            "cascadeDelete": false,
            "caseSensitive": false,
            "compoundFieldName": null,
            "controllerName": null,
        ...
        "recordTypeInfos": [
          {
            ...
            "urls": {
              "layout": "/services/data/v55.0/sobjects/Account/describe/layouts/012000000000000AAA"
            }
          }
        ],
        "supportedScopes": [
...
export async function fetchRecord(payload: FetchRecordPayload) : Promise<any> {
    return {
      attributes: {
        type: "Account",
        url: "/services/data/v55.0/sobjects/Account/0015e000003FtrhAAC",
      },
      Id: "0015e000003FtrhAAC",
      IsDeleted: false,
      MasterRecordId: null,
      Name: "Burlington Coat Factory 2",
      ...
      PhotoUrl: "/services/images/photo/0015e000003FtrhAAC",
      Sic: "546732",
      Industry: "Apparel",
      AnnualRevenue: 3.5e8,
      ...
      Rating: "Warm",
      Site: null,
      OwnerId: "0055e000000yJeCAAU",
      CreatedDate: "2021-04-14T16:26:42.000+0000",
      CreatedById: "0055e000000yJeCAAU",
      LastModifiedDate: "2022-09-27T19:41:14.000+0000",
      LastModifiedById: "0055e000000yJeCAAU",
      SystemModstamp: "2022-09-27T19:41:14.000+0000",
      LastActivityDate: null,
      LastViewedDate: "2022-10-13T22:00:44.000+0000",
      LastReferencedDate: "2022-10-13T22:00:44.000+0000",
      Jigsaw: null,
      ...
      SLA__c: "Silver",
      Active__c: "Yes",
      NumberofLocations__c: 6.0,
      UpsellOpportunity__c: "Maybe",
      SLASerialNumber__c: "5367",
      SLAExpirationDate__c: "2021-05-09",
      WithSeconds__c: "2022-05-10T05:45:00.000+0000",
      WithSeconds1__c: "5:45:0",
    };
}
